...
% end
ifornod = [3 223 18 221 19 219 20 217 21 215 23 212 4];
...
forval=-Pressure*0.5*pi*9.25*Thickness*(1/numnode)*ones(1,numnode);
%forval=-Pressure*0.5*pi*9.25*Thickness*(1/numnode)*[1/6 2/3 1/3*ones(1,9) 2/3 1/6];
% ----------------------------------------
