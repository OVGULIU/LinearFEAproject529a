...
% end
ifornod = [27 28 39 40 48 49 57 31 32 42 43 51 52 60 34 35 44 45 53 54 62 38 47 56 7 12 17 8 13 18 9 14 19];
ifordir = 3*ones(1,size(ifornod,2));
%forval = -2.5*[2/3 2/3 2/3 2/3 2/3];
forval = -10*20*20*[(1/33)*ones(1,33)];
% ----------------------------------------
